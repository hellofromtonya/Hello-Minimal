<p class="site-title" itemprop="headline">
	<a href="<?php echo $url; ?>">
		...
		<img class="site-title--avatar animated bounceInDown" src="<?php echo CHILD_THEME_URL; ?>/assets/images/hellofromtonya.jpg" width="50" height="50" alt="Hello World Blog from hellofromtonya">
	</a>
</p>